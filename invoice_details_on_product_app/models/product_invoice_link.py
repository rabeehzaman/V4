...
class ProductProduct(models.Model):
    ...
    def _count_incoming_invoice_qty(self):
        for product in self:
            ...
            for line in account_move_line_ids:
                if line.move_id.move_type == "out_invoice" or line.move_id.move_type == "in_refund":
    ...
    def invoice_qty_button(self):
        ...
        return {
            ...
            'domain': [('product_id', '=', self.id), ('move_id.move_type', 'in', ['out_invoice', 'in_refund'])],
        }
    ...
    def incoming_invoice_qty_button(self):
        ...
        return {
            ...
            'view_mode': 'tree,form',
            'res_model': 'account.move.line',
            'domain': [('product_id', '=', self.id), ('move_id.move_type', 'in', ['in_invoice', 'out_refund'])],
        }
