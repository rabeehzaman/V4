...
#################################################################################
{
    ...
    "summary"       :  """CUSTOM : This module allow to use multiple units of measure for products in point of sale.Measurment|Unit Of Measure|Multiple Units|Measurement of multi unit""",
